const About = () => {
  return (
    <div className="max-w-9xl border-t border-b border-white/5 p-24 bg-[#0b1121] mx-auto mb-32">
      ...
      <div className="p-10 bg-gradient-to-t from-[#0b1121] via-[#1c2d5b]  to-[#0070F3] shadow-custom shadow-white/10 w-fit mx-auto mt-6 rounded-xl">
        <p className="text-center tracking-wide text-lg text-white max-w-2xl mx-auto mt-4">
          ...
          coding competition. We looking to help others.
        </p>
      </div>
    </div>
  );
